...
<!-- Mirrored from pixelgeeklab.com/html/flatize/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Jul 2021 11:32:30 GMT -->
<head>
	<meta charset="utf-8">
				...
				<div class="container">
					...
					<ul class="nav nav-pills nav-top navbar-right">
						<li class="dropdown langs">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="images/flags/en.gif" alt="English"> <span class="caret"></span></a>
							<ul class="dropdown-menu" role="menu">
								<li><a href="#"><img src="images/flags/ar.gif" alt="AR"></a></li>
								<li><a href="#"><img src="images/flags/ca.gif" alt="CA"></a></li>
								<li><a href="#"><img src="images/flags/de.gif" alt="DE"></a></li>
								<li><a href="#"><img src="images/flags/es.gif" alt="ES"></a></li>
								<li><a href="#"><img src="images/flags/et.gif" alt="ET"></a></li>
								<li><a href="#"><img src="images/flags/fa.gif" alt="FA"></a></li>
								<li><a href="#"><img src="images/flags/fr.gif" alt="FR"></a></li>
								<li><a href="#"><img src="images/flags/ja.gif" alt="JA"></a></li>
							</ul>
						</li>
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-4 collect-item animation">
							<a href="#" class="collect-item-thumb"><img src="images/content/products/ad-1.png" class="img-responsive" alt="Ad"></a>
						...
						<div class="col-xs-4 collect-item animation">
							<a href="#" class="collect-item-thumb"><img src="images/content/products/ad-2.png" class="img-responsive" alt="Ad"></a>
						...
						<div class="col-xs-4 collect-item animation">
							<a href="#" class="collect-item-thumb"><img src="images/content/products/ad-3.png" class="img-responsive" alt="Ad"></a>
			...
			<section class="list-thumbs">
				<div class="container">
					...
					<ul class="list-inline wp-ads animation">
						...
						<li><i class="fa fa-phone"></i><strong>(+91) 86026-48733</strong><span>Contact Customer</span></li>
				...
				<div class="upper-foot">
					<div class="row">r
						<div class="col-xs-6 col-sm-3">
							...
							<address>
								<i class="fa fa-map-marker"></i> 74/A, Bhawanipur Colony,<br>
								Inodre, MP, India<br>
...
<!-- Mirrored from pixelgeeklab.com/html/flatize/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Jul 2021 11:32:38 GMT -->
</html>