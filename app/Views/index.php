		...
		<div role="main" class="main">
			...
			<section class="main-slide">
				<div id="owl-main-demo" class="owl-carousel main-demo">
					<div class="item" id="item1"><img src="public/assets/images/content/slides/slider1.jpg" class="img-responsive" alt="Photo">
					...
					<div class="item" id="item2"><img src="public/assets/images/content/slides/slider2.jpg" class="img-responsive" alt="Photo">
						<div class="item-caption">
							<div class="item-caption-inner">
								<div class="item-caption-wrap">
					...
					<div class="item" id="item3"><img src="public/assets/images/content/slides/slider3.jpg" class="img-responsive" alt="Photo">
						<div class="item-caption">
							<div class="item-caption-inner">
								<div class="item-caption-wrap">
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-4 collect-item animation" style="opacity:0;">
							<a href="#" class="collect-item-thumb"><img src="public/assets/images/content/products/ad-1.png" class="img-responsive" alt="Ad"></a>
						</div>
						<div class="col-xs-4 collect-item animation" style="opacity:0;">
							<a href="#" class="collect-item-thumb"><img src="public/assets/images/content/products/ad-2.png" class="img-responsive" alt="Ad"></a>
						</div>
						<div class="col-xs-4 collect-item animation" style="opacity:0;">
							<a href="#" class="collect-item-thumb"><img src="public/assets/images/content/products/ad-3.png" class="img-responsive" alt="Ad"></a>
						</div>
					</div>
				</div>
			</section>
						...
						<div class="col-xs-6 animation">
							<article class="post">
								<div class="post-image">
									...
									<img class="img-responsive" src="public/assets/images/content/blog/demo-1.jpg" alt="Blog">
								</div>
						...
						<div class="col-xs-6 animation">
							<article class="post">
								<div class="post-image">
									...
									<img class="img-responsive" src="public/assets/images/content/blog/demo-2.jpg" alt="Blog">
								</div>
						...
						<div class="col-sm-6">
							<div class="product-preview">
								<ul class="bxslider" id="slider1">
									<li><img alt="" class="img-responsive" src="<?php echo base_url();?>/public/assets/images/content/products/product-1.jpg"></li>
									<li><img alt="" class="img-responsive" src="public/assets/images/content/products/product-1-1.jpg"></li>
									<li><img alt="" class="img-responsive" src="public/assets/images/content/products/product-1-2.jpg"></li>
									<li><img alt="" class="img-responsive" src="public/assets/images/content/products/product-1-3.jpg"></li>
									<li><img alt="" class="img-responsive" src="public/assets/images/content/products/product-1-4.jpg"></li>
								</ul>

								<ul class="list-inline bx-pager">
									<li><a data-slide-index="0" href="#"><img alt="" class="img-responsive" src="public/assets/images/content/products/product-thumb.jpg"></a></li>
									<li><a data-slide-index="1" href="#"><img alt="" class="img-responsive" src="public/assets/images/content/products/product-thumb-1.jpg"></a></li>
									<li><a data-slide-index="2" href="#"><img alt="" class="img-responsive" src="public/assets/images/content/products/product-thumb-2.jpg"></a></li>
									<li><a data-slide-index="3" href="#"><img alt="" class="img-responsive" src="public/assets/images/content/products/product-thumb-3.jpg"></a></li>
									<li><a data-slide-index="4" href="#"><img alt="" class="img-responsive" src="public/assets/images/content/products/product-thumb-4.jpg"></a></li>
								</ul>
							</div>
						</div>
						<div class="col-sm-6">
										...
										<div id="collapseThree" class="panel-collapse collapse">
											<div class="panel-body post-comments">
												<ul class="comments">
													<li>
														<div class="comment">
															<div class="img-circle"> <img class="avatar" width="50" alt="" src="public/assets/images/content/blog/avatar.png"> </div>
...
<!-- Mirrored from pixelgeeklab.com/html/flatize/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Jul 2021 11:31:45 GMT -->
</html>