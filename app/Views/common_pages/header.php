			...
			<div id="top">
				<div class="container">
					...
					<ul class="nav nav-pills nav-top navbar-right">
						...
						<!--	<span class="shopping-bag">9</span></a>
				...
				<div class="container">
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-nav pull-right">
							<li>
								<form class="form-inline" style="margin-top: 20px; width:500px;">
									<input class="form-control mr-sm-2" style="width:300px;" type="text" placeholder="Search.." aria-label="Search">
									<button  style="padding:5px;" class="btn btn-outline-success btn-rounded btn-sm my-0" type="submit"><i class="fa fa-search"></i></button>
								</form>
												...
												<ul class="list-unstyled sub-menu list-md-pro">
													<li class="product">
														<div class="product-thumb-info">
															...
															<div class="product-thumb-info-content">
																<h4><a href="">Men’s Fashion and Style</a></h4>
